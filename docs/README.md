...
- **[Built-in Tools](tools.md)** — the built-in tools mini can call,
  including the filesystem boundary that confines most of them.
- **[Extending mini](extending.md)** — add your own tools via
